	...
	<div class="row">
		<div class="container">
			...
			<nav class="bradcaump-content" style="text-align: right;">
				...
				<span class="brd-separetor">/</span>
				<span class="breadcrumb_item active">회차연재</span>
			</nav>
			...
			<div class="wrapper account__form" id="wrapper" style="margin-top:0 !important;">
				...
				<!-- 회차제목 -->
				<div><input id="title" name="title" type="text" class="g-input" style="font-size:23px; margin-bottom:5%;" placeholder="회차 제목을 입력하세요." /></div>
				...
				<textarea id="author_say" style="padding: 16px; margin-bottom : 3%;" placeholder="300자 이하로 작성해주세요." maxlength="300" onkeyup="chk_word(this.value)"></textarea>
