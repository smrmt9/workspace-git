		...
		<div class="container">
			...
			<div class="wrapper" id="wrapper">
				...
				<nav class="bradcaump-content" style="text-align: right;">
					...
					<span class="brd-separetor">/</span>
					<span class="breadcrumb_item active">1회</span>
				</nav>				
				...
				<div class="title_area">
					<h2 class="main_title" style="text-align: center;">
						공기 청정, 하늘은 맑음 
						<span id="chevron_status" style="cursor: pointer;"><i class="fa fa-chevron-down" aria-hidden="true"></i></span>
					</h2>
					
					<!-- 소설 회차리스트 -->
					<div class="vol_list_area col-lg-12">
						<div class="vol_list">
							<ul>
								<li><a href="#">10. 10회차 연재소설 제목</a></li>
								<li><a href="#" class="vol_selected">9. 9회차 연재소설 제목</a></li>
								<li><a href="#">8. 8회차 연재소설 제목</a></li>
								<li><a href="#">7. 7회차 연재소설 제목</a></li>
								<li><a href="#">6. 6회차 연재소설 제목</a></li>
								<li><a href="#">5. 5회차 연재소설 제목</a></li>
								<li><a href="#">4. 4회차 연재소설 제목</a></li>
								<li><a href="#">3. 3회차 연재소설 제목</a></li>
								<li><a href="#">2. 2회차 연재소설 제목</a></li>
								<li><a href="#">1. 1회차 연재소설 제목</a></li>
							</ul>
						</div>
					</div>
					
					<h4 class="sub_title" style="text-align: center;"> 9회차 연재소설 제목 </h4>
				</div>
				...
				<div class="account__form" style="text-align: center;">
					<div class="form__btn">
						<button class="btn" id="prev_btn" type="button">이전화</button>
						<button class="btn" id="list_btn" type="button">목록</button>
						<button class="btn" id="next_btn" type="button">다음화</button>
					</div>
				</div>
...
$(function() { 
	...
	//회차 리스트 보기 
	$('#chevron_status').click(function(){
		$('.vol_list_area').toggle();
		//chevron 아이콘 change
